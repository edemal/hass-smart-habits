...
Plans:
- [x] 05-01-PLAN.md — TDD: PresencePatternDetector implementation + coordinator wiring
...
Plans:
- [x] 06-01-PLAN.md — TDD: AcceptedPatternsStore + coordinator single executor job refactor
- [x] 06-02-PLAN.md — TDD: WebSocket accept_pattern command + get_patterns extension
...
- [ ] 07-02-PLAN.md — TDD: WebSocket extensions (ws_accept_pattern automation creation + ws_preview_automation)
...
- [ ] 08-02-PLAN.md — Full panel web component (pattern cards, category grouping, accept/dismiss/customize, stale automations)
